...
<h2 class="nmodt">질문 수정하기</h2>
<form action="<%=request.getContextPath()%>/home/board/pquestion_modify_action.jsp" method="post" id="boardForm">
...
<table>
	<tr>
		<th>제목</th>
		<td>
			<input type="text" name="subject" id="subject" size="40" value="<%=board.getPqTitle() %>">
		</td>
	</tr>
	<tr>		
		<th>내용</th>
		<td>
			<textarea rows="7" cols="60" name="content" id="board_content"><%=board.getPqContent() %></textarea>
		</td>
	</tr>
	<tr>
		<th colspan="2">
