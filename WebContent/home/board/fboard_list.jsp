...
<%
	List<FBoardDTO> boardList=FBoardDAO.getDAO().getAllFBoardList();
	MemberDTO loginMember=(MemberDTO)session.getAttribute("loginMember");
%>

<div class="faq-list">
									<div class="faq-tab-item selected">전체</div>
									...
									<div class="faq-tab-item" id="as" onClick="location.href='<%=request.getContextPath()%>/home/index.jsp?workgroup=board&work=fboard_category_as';" style="cursor:pointer;">AS/반품/환불</div>
...
<div class="fboard-list">
		<% for(FBoardDTO board:boardList) { %>
			...
			<div class="removebutton" onclick="location.href='<%=request.getContextPath()%>/home/index.jsp?workgroup=board&work=fboard_remove_action&num=<%=board.getFbBbsno()%>'">글삭제</div>
			<div class="modifybutton" onclick="location.href='<%=request.getContextPath()%>/home/index.jsp?workgroup=board&work=fboard_modify&num=<%=board.getFbBbsno()%>'">글수정</div>
	<% } %>
