...
<%
	List<FBoardDTO> faqList=FBoardDAO.getDAO().getFAQList("상품");
%>
...
<div class="faq-list">
				...
				<div class="faq-tab-item selected" id="pr" onClick="location.href='<%=request.getContextPath()%>/home/index.jsp?workgroup=board&work=fboard_category_pr';" style="cursor:pointer;">상품</div>
